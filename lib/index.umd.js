(function (global, factory) {
    ...
    function processCreateParams(params) {
        ...
        if (errorMap)
            return { errorMap: errorMap, description, metadata };
    ...
    function extractFrom(schema) {
        var _a;
        const from = (_a = schema._def.metadata) === null || _a === void 0 ? void 0 : _a.from;
        if (from)
            return from;
    ...
    function objectInputKeys(shape) {
        const keys = [];
    ...
    class ZodObject extends ZodType {
        ...
        _getCached() {
            ...
            const outputKeys = exports.util.objectKeys(shape);
